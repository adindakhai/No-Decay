    ...
    <div className="grid grid-cols-2 gap-4">
      <div className="bg-orange-500 rounded-xl p-4 text-white">
        <div className="flex justify-between items-start">
          <div>
            <p className="text-sm font-medium opacity-90">Container 01</p>
            <h3 className="text-xl font-bold mt-1">WARNING</h3>
          </div>
      ...
      <div className="bg-red-600 rounded-xl p-4 text-white">
        <div className="flex justify-between items-start">
          <div>
            <p className="text-sm font-medium opacity-90">Container 02</p>
            <h3 className="text-xl font-bold mt-1">SPOILED</h3>
          </div>
          <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
              <path
